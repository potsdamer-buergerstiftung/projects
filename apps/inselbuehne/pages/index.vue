<template>
  <div>
    <section class="bg-green-100">
      <div
        class="container grid items-center grid-cols-6 gap-16 px-4 pt-48 mx-auto pb-12 md:pb-24"
      >
        <div class="max-w-xl col-span-6 md:col-span-3">
          ...
          <p class="mt-6 text-lg leading-relaxed">
            Wir stellen Künstlerinnen und Künstlern ein weiteres Jahr den Ort
            zur Verfügung, der letztes Jahr tausende Zuschauerinnen und
    ...
    <section class="bg-gray-50">
      <div
        class="container grid items-center grid-cols-2 gap-16 px-4 pt-16 mx-auto"
      >
        ...
        <div class="order-1 col-span-2 lg:col-span-1 lg:order-2">
          ...
          >
            ...
            Stadt. Sie ist für viele Potsdamerinnen und Potsdamer ein
            Traditionsort.
          </p>
        </div>
      </div>
    ...
    <section class="bg-gray-50">
      <div
        class="max-w-3xl px-4 pt-24 md:pt-32 pb-24 md:pb-32 mx-auto text-center"
      >
        ...
        <p class="mt-4 text-lg leading-relaxed text-gray-600">
          ...
          <span class="font-bold">für das Besuchen</span> aller Veranstaltungen
          ab dem 15. Juni <span class="font-bold">Tickets notwendig</span>. Wir
          arbeiten zurzeit an einer Implementierung unseres neuen Ticket-Systems
          und werden dieses
          <span class="font-bold">zum 1. Juni</span> bereitstellen. Bis dahin
          können die Veranstaltungen auch ohne Registrierung besucht werden.
        </p>
        <NuxtLink
          to="/veranstaltungen"
