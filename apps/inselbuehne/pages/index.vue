...
<template>
    <section class="bg-green-100">
        <div class="container mx-auto px-4 pt-24 pb-12 grid grid-cols-2 gap-16 items-center">
            <div>
                ...
                <button class="mt-5 px-5 py-3 shadow-md rounded-tl-lg rounded-br-lg bg-green-500 text-white text-lg font-medium">
        ...
        <div class="container mx-auto px-4 pt-16 grid grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <p class="text-lg mt-4 leading-relaxed text-gray-600">
                    Inselbühne haben wir die 1974 errichtete Freilichtbühne auf der Freundschaftsinsel neu benannt. Seit
                    2012 wurde sie nicht mehr genutzt und es gab Pläne, sie abzureißen. Das wollten wir verhindern, denn
    ...
    <section class="bg-gray-50">
        <div class="max-w-3xl mx-auto px-4 pt-32 pb-32 text-center">
            <h4 class="uppercase text-green-500 font-bold tracking-widest text-sm">Los geht's</h4>
            <h1 class="mt-3 font-serif text-4xl">Hol' dir dein Ticket</h1>
            <p class="mt-4 text-lg text-gray-600 leading-relaxed">
                Wegen aktueller Verordnungen dürfen wir nur 140 Personen mit entsprechendem Abstand zulassen. Um eine
