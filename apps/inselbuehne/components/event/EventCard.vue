<template>
    <NuxtLink :to="`/veranstaltungen/${eventId}`"
        class="w-full overflow-hidden rounded-tl-2xl rounded-br-2xl bg-white shadow-lg transition hover:shadow-xl hover:-translate-y-2 duration-300 cursor-pointer grid grid-cols-5 min-h-max lg:h-56">
        <div class="col-span-5 lg:col-span-2 w-full h-64 lg:h-full relative">
            ...
            <div
                class="absolute left-6 lg:left-auto lg:right-6 top-1/2 bg-white shadow-md p-4 -translate-y-1/2 rounded-tl-lg rounded-br-lg">
        ...
        <div
            class="col-span-5 lg:col-span-3 p-6 lg:p-10 flex flex-col lg:flex-row items-start lg:items-center lg:space-x-10 justify-between">
            <div class="text-left">
...
const { title, eventId, start, summary, image, registration_needed = false } = defineProps<{
    eventId: string;
    title: string
    summary: string;
    start: string;
