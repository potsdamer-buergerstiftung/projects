<template>
  <div @mouseenter="onHover()" @mouseleave="onLeave()" ref="node"
    class="group flex flex-row justify-start lg:flex-col relative">
    <NuxtLink class="group flex flex-row justify-start gap-1 px-4 lg:px-3 xl:px-4 py-4 outline-none lg:flex-col lg:gap-0 lg:py-2" :to="link">
      <span
    ...
    <ul class="absolute px-4 lg:py-20 flex-col w-auto whitespace-nowrap"
