<template>
  <div @mouseenter="onHover()" @mouseleave="onLeave()" ref="node" @click="onClick()"
    ...
    <ul class="relative mb-4 w-auto flex-col whitespace-nowrap px-9 lg:absolute lg:mb-0 lg:px-4 lg:py-20" ref="subMenu"
...
watch(node, (newVal) => {
  index.value = Array.prototype.indexOf.call(newVal.parentNode.childNodes, newVal) - 1;
})
