    ...
    <section>
      ...
      >
        ...
        <div class="order-3 md:order-4 lg:order-3">
          ...
          <h4 class="font-header mt-6 text-xl font-bold md:text-lg">
            Ehrenamt
          </h4>
          <p class="mt-6">E-Mail</p>
          ...
          <form>
            ...
            <div class="mt-6 flex items-start">
              ...
              <label
                ...
                class="ml-2 max-w-xl text-sm font-medium"
                >Ich erkläre mich einverstanden, dass die eingegebenen Daten für
                den Versand des Newsletters weiterverarbeitet werden.</label
              >
            </div>
          </form>
        </div>
