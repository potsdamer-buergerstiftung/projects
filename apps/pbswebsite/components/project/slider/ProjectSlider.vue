    ...
    <swiper-slide v-for="project in projects">
      <section class="relative h-screen w-full snap-start bg-red-200">
        <div class="absolute h-full w-full">
          <DirectusImage :asset-id="project.image" :width="2000" :quality="30"
        ...
        <div class="absolute top-1/2 w-full -translate-y-1/2">
          <div class="container mx-auto px-4">
            <ul class="mb-4 flex flex-row space-x-4" v-if="project.categories">
              <li class="text-md font-medium text-white" v-for="{
            ...
            <ClientOnly>
              <div class="mt-4 max-w-2xl text-slate-300" v-html="project.summary" v-if="project.summary" />
            ...
            <NuxtLink :to="`/projekte/${project.id}`"
              ...
              <svg xmlns="http://www.w3.org/2000/svg"
                class="transition-color ml-1 h-5 w-5 transition-transform group-hover:translate-x-1" fill="none"
