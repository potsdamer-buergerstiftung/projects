  ...
  >
    <swiper-slide v-for="project in projects">
      <section class="relative w-full h-screen bg-red-200 snap-start">
        ...
        <div
          class="absolute top-0 left-0 bottom-0 right-0 bg-slate-900 opacity-60"
        />
        <div
          class="absolute top-0 left-0 bottom-0 right-0 bg-black lazy-preloader"
        />
        <div class="absolute w-full top-1/2 -translate-y-1/2">
          <div class="container mx-auto px-4">
            <h1
              class="text-white font-header text-4xl md:text-6xl lg:text-7xl font-bold"
            >
              {{ project.title }}
            </h1>
            ...
            <NuxtLink
              to="/"
              class="group inline-flex items-center text-white mt-8 font-bold hover:text-slate-400 transition"
            >
              Projekt anzeigen
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="transition-color transition-transform group-hover:translate-x-1 ml-1 h-5 w-5"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                stroke-width="2"
