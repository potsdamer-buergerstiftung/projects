<template>
    <div class="flex flex-col gap-4">
        <ul class="flex flex-row gap-6 mb-8">
            <li class="relative">
                <button
                    class="font-bold font-header after:h-0.5 after:bg-slate-900 after:w-full after:absolute after:-bottom-2 after:left-0">Log-in</button>
            </li>
            <li class="relative">
                <button
                    class="after:opacity-0 font-bold font-header after:h-0.5 after:bg-slate-900 after:w-full after:absolute after:-bottom-2 after:left-0">Registrieren</button>
            </li>
            <li class="relative" v-for="provider in providers.data">
                <a :href="loginUrl(provider.name).toString()"
                    class="after:opacity-0 font-bold font-header after:h-0.5 after:bg-slate-900 after:w-full after:absolute after:-bottom-2 after:left-0">Log-in
        ...
        <div class="col-span-3">
            <div class="mb-6 flex items-start">
                ...
                <label for="remember" class="ml-2 max-w-xl text-sm font-medium">Ich erkläre mich einverstanden, dass die
                    eingegebenen Daten
                    zu Zwecken des Beantwortens meines Anliegens weiterverarbeitet
                    werden.</label>
            </div>
        </div>
        <div class="col-span-3">
