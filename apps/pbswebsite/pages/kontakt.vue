    ...
    <div>
        ...
        <section class="bg-slate-100">
            <div class="container mx-auto px-4 grid grid-cols-4 py-16 gap-8">
                <div>
                    <h1 class="font-bold font-header text-3xl">
                        Unsere Standorte
                    </h1>
        ...
        <section class="bg-slate-100">
            <div class="container mx-auto px-4 grid grid-cols-4 py-16 gap-8">
                <div>
                    ...
                    <p class="mt-4">Füll' einfach das Formular aus oder <b>sende uns eine E-Mail</b></p>
                </div>
                <div>
                    <h2 class="font-bold font-header text-xl">MAZ-Pyramide</h2>
                ...
                <div>
                    ...
                    <p class="mt-4">Besuchszeiten: Freitag - Samstag</p>
                    <p>18 Uhr - 20 Uhr</p>
                    <NuxtLink to="https://www.inselbuehne-potsdam.de" class="font-bold">inselbuehne-potsdam.de
                    </NuxtLink>
                </div>
            </div>
        </section>
