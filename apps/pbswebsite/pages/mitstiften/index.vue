  ...
  <div>
    ...
    <PageTitle title="Unterstützen & engagieren">
      <template #description>
        Erfahren Sie, wie Sie uns mit Geld oder mit Ihrer Zeit unterstützen
        können.
      </template>
      <template #breadcrumb>
    ...
    <section class="bg-white">
      <div
        class="container mx-auto grid grid-cols-8 gap-x-8 gap-y-12 px-4 pt-8 pb-16"
      >
    ...
    <section class="bg-slate-100">
      <div
        class="container mx-auto grid grid-cols-8 gap-x-8 gap-y-12 px-4 py-16"
      >
        <div class="col-span-8 lg:col-span-2">
        ...
        <div class="col-span-8 md:col-span-4 lg:col-span-3">
          ...
          <p class="mt-4">
            Mit unserem elektronisch generierten Lastschriftmandat können Sie
